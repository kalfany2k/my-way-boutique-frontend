    ...
    <>
      ...
      >
        ...
        <div className="relative mb-6 flex w-4/5 flex-row justify-around">
          <button
            className={`w-[45%] ${menuOption ? "ring-1 ring-black" : ""} rounded-xl bg-gradient-to-r from-slate-300 to-rose-200 p-2 text-xl`}
            onClick={() => {
          ...
          <button
            className={`w-[45%] rounded-xl bg-gradient-to-l from-slate-300 to-rose-200 p-2 text-xl ${!menuOption ? "ring-1 ring-black" : ""}`}
            onClick={() => {

...
export const categories: Category[] = [
  ...
  {
    name: "Prima baie",
    path: "/categorii/prima-baie",
    subcategories: [
      { name: "Set produse prima baita", path: "/produse/prima-baita/set" },
  ...
  },
  {
    ...
    path: "/categorii/prima-aniversare",
    subcategories: [
      { name: "Baietei", path: "/categorii/prima-aniversare?gender=baieti" },
      { name: "Fetite", path: "/categorii/prima-aniversare?gender=fete" },
      { name: "Set mot", path: "/categorii/prima-aniversare/set-mot" },
      { name: "Set turta", path: "/categorii/prima-aniversare/set-turta" },
    ...
    subcategories: [
      {
        ...
        path: "/produse/tricouri/aniversare-un-an",
      },
      {
        name: "Seturi aniversare 2-10 ani",
        path: "/produse/tricouri/aniversare-2-10-ani",
      },
